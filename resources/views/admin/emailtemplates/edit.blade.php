			...
			<div class="row">
				<div class="offset-md-3 col-md-6">
					<div class="card card-primary">
						...
						@endif
						{{ Form::model( $template, ['method' => 'POST', 'route' => 'admin.editEmailTemplate', 'id'=>'edit-email-template-form' ]) }}
						{{ Form::hidden( 'action','edit' ) }}
							{{ Form::hidden( 'id', $template['id'], ['id'=>'id' ] ) }}
							@include('admin.emailtemplates.formElements',['submitButtonText' => 'Update'])
						{{ Form::close() }}
					  </div>
				</div>
			</div>
